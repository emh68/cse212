...
public class Translator
{
    ...
    public void AddWord(string fromWord, string toWord)
    {
        ...
        // Adds the key which is fromWord and the value which is toWord to the _words dictionary
    ...
    {
        // Todo Problem 1 - ADD YOUR CODE HERE
        // Try to get the value of the key fromWord and return it as translation
