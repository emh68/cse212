...
//         public List<Node> Children { get; } = new();  // Implicit initialization
//         public Node? Parent { get; set; } // Nullable Parent field
...
//     private readonly Node root; // Marked as readonly because it's set only in the constructor

//     public FileSystem()
//     {
//         root = new Node("root", false); // Root folder
//     }

//     public void Run()
//     {
//         // Display  file structure when the program starts
...
//                     break;
//                 case 8:
//                     // Display the structure explicitly when option 8 is selected
//                     DisplayFileStructure();
//                     break;
//                 case 9:
...
//             // Display file structure only if action was successful
//             if (actionSuccessful)
//             {
//                 DisplayFileStructure();  // Update and show the file structure after changes
//             }
//         }
//     }

//     private static void DisplayMenu()  // Marked as static since it does not depend on instance variables
//     {
//         Console.WriteLine("\nMenu:");
...
//             return false;
//         }
//         return RemoveNode(fileName, true);
//     }
...
//             return false;
//         }
//         return AddNode(folderName, false);
//     }
...
//             return false;
//         }
//         return RemoveNode(folderName, false);
//     }
...
//             return false;
//         }
//         return MoveNode(folderName, false);
//     }
...
//         Node? result = SearchNode(root, fileName, true);
...
//         Node? parent = SearchNode(root, parentName, false);
//         if (parent == null)
//         {
...
//         parent.Children.Add(new Node(name, isFile) { Parent = parent });
...
//         // Safely navigate through potentially null Parent
...
//         Node? newParent = SearchNode(root, newParentName, false);

//         if (newParent == null)
//         {
//             Console.WriteLine($"Folder '{newParentName}' not found.");
//             return false;
//         }

//         if (newParent.IsFile)
//         {
//             Console.WriteLine("Cannot move into a file.");
//             return false;
//         }

//         // Safely handle nullable Parent before reassigning
//         node.Parent?.Children.Remove(node);
...
//     private static Node? SearchNode(Node node, string name, bool isFile)
//     {
//         if (node.Name.Equals(name, StringComparison.OrdinalIgnoreCase) && node.IsFile == isFile)
//         {
//             return node;
//         }
...
//         {
//             Node? foundNode = SearchNode(child, name, isFile);
//             if (foundNode != null)
//             {
//                 return foundNode;
//             }
...
public class FileSystem
{
    ...
    public void Run()
    {
        ...
        while (true)
        {
            ...
            bool actionSuccessful = false;  // Flag to track if the action was successful
